...
public class Erregistratu extends JFrame {
	...
	public Erregistratu() {
		...
		lblErabiltzailea.setBounds(30, 70, 57, 14);
		...
		tFErregistroData.setBounds(105, 167, 140, 20);
		contentPane.add(tFErregistroData);


		tFErregistroData.setText(Metodoak.getDataGaur());


		tFPremiumMuga = new JTextField();
		tFPremiumMuga.setEditable(false);
		tFPremiumMuga.setColumns(10);
		tFPremiumMuga.setBounds(105, 192, 140, 20);
		...
		btnGorde.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (Metodoak.pasahitzBerdinak(pasahitza, pasahitza2)) {
					
					if (Metodoak.dataBalidatu(tFJaioData.getText())) {
						
						if(db.datuakBeteta(tFIzena, tFAbizena, tFErabiltzailea, tFJaioData, pasahitza)) {
							
							Free user = new Free(tFIzena.getText(), tFAbizena.getText(), tFErabiltzailea.getText(),pasahitza.getText(), tFJaioData.getText());
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (tFPremiumMuga.getText().isEmpty()) {
					tFPremiumMuga.setText(Metodoak.urteaGehitu(Metodoak.getDataGaur()));
				} else {
					tFPremiumMuga.setText(Metodoak.urteaGehitu(tFPremiumMuga.getText()));
				}


			}
		});
		btnNewButton_2.setBounds(265, 260, 125, 23);
